...
program = "/disk"
folder = "/R16"
first_file = 32  # REMEMEBR THIS IS FOR THE ENERGY_STEPS, NOT OUTPUT_STEPS
num_zeros_str = 5
...
def read_data(input_dir, file_name, ext):
    ...
    for n in range(first_file, N):
        ...
        try:
            ...
            print("File not found: ", file_name + node + ext)
            continue
...
def average_data(root):
    ...
    input_dir = "data/pointvortices" + program + folder + "/EnergyFlux/"
    file_name = "Energy."
    output_file = "data/pointvortices" + program + folder + "/average/EnergyFlux.txt"
    ...
    input_dir = "data/pointvortices" + program + folder + "/EnergyProf/"
    file_name = "Energy."
    output_file = "data/pointvortices" + program + folder + "/average/EnergyProf.txt"
    ...
    input_dir = "data/pointvortices" + program + folder + "/NumVortices/"
    file_name = "NumVortices."
    output_file = "data/pointvortices" + program + folder + "/average/NumVortices.txt"
