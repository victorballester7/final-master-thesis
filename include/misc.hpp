...
void EnergyProf(int n, double* X, int N_R, double* E, double R_max, string filename_output, void* param);

void EnergyFlux(double dt, int N_R, double* E0, double* E1, double R_max, string filename_output);
